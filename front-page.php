...
get_header(); ?>
	<div class="hero">
	  ...
	  <h1 class="overlay-title">Parkview</h1>
	</div>
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
		    ...
		    <p>PARKVIEW MAGAZINE is a collection of life’s allure through a showcase of design, entertaining, awesome and inspiring people, shared experiences, and spaces. We capture how individual taste is cultivated through living and common spaces and encourage sharing life’s profound moments in them. Not so much of a keeping up with the trends type of read, but more of a cultured visual and reading experience that embraces and influences a lifestyle, PARKVIEW MAGAZINE is a reference for inspiration and cunning perspective on external environments. Our dialogue with some of the most intriguing human beings around, in some of the most aesthetically and functionally pleasing areas we can find, PARKVIEW MAGAZINE is captivating in its own right, submerging the reader into the glory of each page.</p>
		  </section>
		  <section>
